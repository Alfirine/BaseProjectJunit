...
public class DriverFactory implements IDriverFactory {
    ...
    public static final Browser BROWSER = Browser.getValue(Configuration.getInstance().getProperty("browser"));
    ...
    private RemoteWebDriver getRemoteDriver() {
        ...
        switch (BROWSER) {
            case CHROME:
                ...
                chromeOptions.setCapability("name", "Создатель: " + System.getProperty("user.name")); //user name
